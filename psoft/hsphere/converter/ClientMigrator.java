...
/* loaded from: hsphere.zip:psoft/hsphere/converter/ClientMigrator.class */
public class ClientMigrator extends C0004CP {
    ...
    private static void addCredit(Account a, String balance) throws Exception {
        ...
        double amount = -(Double.parseDouble(balance) - a.getBill().getBalance());
        a.getBill().addEntry(6, now, -1L, -1, Localizer.translateMessage("bill.b_balance"), now, (Date) null, (String) null, amount);
        a.getBill().setCredit(0.0d);
        Connection con = Session.getDb();
        try {
