...
/* loaded from: hsphere.zip:psoft/hsphere/resource/apache/UrchinResource.class */
public class UrchinResource extends Resource {
    ...
    public void delete() throws Exception {
        ...
        if (this.initialized) {
            String dir = recursiveGet("path").toString();
            Session.getLog().debug("Urchin delete: dir=" + dir);
            List list = new ArrayList();
            list.add(dir);
            HostEntry he = recursiveGet("host");
            he.exec("urchin-remove", list);
        }
        Connection con = Session.getDb();
        PreparedStatement ps = null;
        try {
