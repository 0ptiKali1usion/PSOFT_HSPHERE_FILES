...
/* loaded from: hsphere.zip:psoft/hsphere/resource/admin/lservers/WinServerInfo.class */
public class WinServerInfo extends LogicalServerInfo {
    ...
    public List getInfo(long lserverId) throws Exception {
        ...
        try {
            ...
            ps2.close();
            PreparedStatement ps3 = con.prepareStatement("SELECT count(*) FROM iis_vhost  WHERE host_id = ?");
