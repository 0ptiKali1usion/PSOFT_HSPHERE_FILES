...
/* loaded from: hsphere.zip:psoft/hsphere/resource/admin/params/UnixPathParam.class */
public class UnixPathParam extends EditParam {
    public UnixPathParam(BaseParam param) {
        super(param);
    }
