...
/* loaded from: hsphere.zip:psoft/hsphere/resource/vps/VPSTCPLimitResource.class */
public class VPSTCPLimitResource extends VPSGenericResource {
    public VPSTCPLimitResource(ResourceId id) throws Exception {
        super(id);
    ...
    public VPSTCPLimitResource(int type, Collection initValues) throws Exception {
    ...
    public static String getRecurrentChangeDescripton(InitToken token, Date begin, Date end) throws Exception {
        return Localizer.translateMessage("bill.vps.tcplimit.recurrent", new Object[]{token.getPeriodInWords(), new Double(token.getFreeUnits()), new Double(getAmount(token)), new Double(getAmount(token) - token.getFreeUnits()), f42df.format(begin), f42df.format(end)});
    }
    ...
    public String getErrorMessage() {
        return "Cannot get VPS TCP Sockets Limit for ";
    }

    @Override // psoft.hsphere.resource.vps.VPSGenericResource
    public String getResourceName() {
        return "VPS TCP Sockets Limit";
    }
}
