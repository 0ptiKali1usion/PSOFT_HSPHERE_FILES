...
/* loaded from: hsphere.zip:psoft/hsphere/resource/vps/VPSMemoryLimitResource.class */
public class VPSMemoryLimitResource extends VPSGenericResource {
    public VPSMemoryLimitResource(ResourceId id) throws Exception {
        super(id);
    ...
    public VPSMemoryLimitResource(int type, Collection initValues) throws Exception {
    ...
    public static String getRecurrentChangeDescripton(InitToken token, Date begin, Date end) throws Exception {
        return Localizer.translateMessage("bill.vps.memlimit.recurrent", new Object[]{token.getPeriodInWords(), new Double(token.getFreeUnits()), new Double(getAmount(token)), new Double(getAmount(token) - token.getFreeUnits()), f42df.format(begin), f42df.format(end)});
    }
    ...
    public String getErrorMessage() {
        return "Cannot get VPS Memory Limit for ";
    }

    @Override // psoft.hsphere.resource.vps.VPSGenericResource
    public String getResourceName() {
        return "VPS Memory Limit";
    }
}
