...
/* loaded from: hsphere.zip:psoft/hsphere/resource/vps/VPSHardCPULimitResource.class */
public class VPSHardCPULimitResource extends VPSGenericResource {
    public VPSHardCPULimitResource(ResourceId id) throws Exception {
        super(id);
    ...
    public VPSHardCPULimitResource(int type, Collection initValues) throws Exception {
    ...
    public void physicalCreate(long targetHostId) throws Exception {
        ...
        if (vps.isPsInitialized()) {
            ...
            he.exec("vps-hcpulimit-set", args);
    ...
    public static String getRecurrentChangeDescripton(InitToken token, Date begin, Date end) throws Exception {
        return Localizer.translateMessage("bill.vps.hardcpulimit.recurrent", new Object[]{token.getPeriodInWords(), new Double(token.getFreeUnits()), new Double(getAmount(token)), new Double(getAmount(token) - token.getFreeUnits()), f42df.format(begin), f42df.format(end)});
    }

    @Override // psoft.hsphere.resource.vps.VPSGenericResource
    public String getVPSLabel() {
        return "vps.hardcputlimit";
    }

    @Override // psoft.hsphere.resource.vps.VPSGenericResource
    public String getGetFilename() {
        return "vps-hcpulimit-get";
    }
    ...
    public String getErrorMessage() {
        return "Cannot get VPS CPU Hard Limit for ";
    }

    @Override // psoft.hsphere.resource.vps.VPSGenericResource
    public String getResourceName() {
        return "VPS Hard CPU Limit";
    }
}
