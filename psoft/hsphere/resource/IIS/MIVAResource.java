...
/* loaded from: hsphere.zip:psoft/hsphere/resource/IIS/MIVAResource.class */
public class MIVAResource extends Resource implements HostDependentResource {
    ...
    public void physicalDelete(long targetHostId) throws Exception {
        ...
        WinHostEntry he = (WinHostEntry) HostManager.getHost(targetHostId);
        getMivaOperator().setHost(he);
        getMivaOperator().uninstallMivaMerchant();
    }
    ...
    public TemplateModel FM_setup() throws Exception {
        ...
        try {
            ...
            Session.getLog().debug("Error setting configuring miva merchant 5");
            return new TemplateString(Localizer.translateMessage("miva.installation.failed.setup"));
        }
    }
    ...
    protected MivaOperator getMivaOperator(boolean reload) throws Exception {
        if (this.mivaOperator == null || reload) {
            this.mivaOperator = MivaOperatorFactory.getInstance().getMivaOperator(getVersion(), 2, this);
        }
