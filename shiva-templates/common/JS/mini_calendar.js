var isV5Up = (isIE || isNN6up || isGecko || isOpera5up);
var isNNLayers = (isNN && propertyExists('layers', document) && (document.layers != null));
var isDocAll = (propertyExists('all', document) && (document.all != null));
var isDocEl = (propertyExists('getElementById', document) && (document.getElementById != null));
